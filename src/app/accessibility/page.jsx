...
export default function BarrierefreiheitPage() {
  return (
    <>
      <main className={styles.container} aria-label="Barrierefreiheit und digitale Inklusion">
        <section className={styles.hero}>
          <h1 tabIndex={0}>Barrierefreiheit – Digitale Teilhabe für alle</h1>
          <p>
          ...
          <div className={styles.imageWrapper}>
            <Image
              src="/images/old.webp"
              alt="Symbolbild für digitale Barrierefreiheit: Hände, die ein Netzwerk halten"
              width={1600}
              height={600}
              priority
        ...
        <section className={styles.why}>
          <h2 tabIndex={0}>Warum Barrierefreiheit wichtig ist</h2>
          <ul>
